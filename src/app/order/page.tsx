...
const SingleOrder = () => {
  ...
  const  orderInfo =  useSelector((state: RootState) => state.order.shipping_info);
  let content = null;
  //const { name, country, city, contact, invoice, createdAt, cart, shippingCost, discount, totalAmount,paymentMethod} = cart_products;
    content = (
      <>
              ...
              <div className="row">
                <div className="col-xl-12">
                  <div className="invoice_msg mb-40">
                    <p className="text-black alert alert-success">Cảm ơn <strong>{orderInfo.firstName}</strong> đã tin tưởng và đặt hàng! Đơn hàng của bạn đã được xác nhận và sẽ được gửi đến bạn trong thời gian sớm nhất. Chúc bạn một ngày vui vẻ và mong được phục vụ bạn lần sau! </p>
                  </div>
                </div>
              </div>
            </div>
